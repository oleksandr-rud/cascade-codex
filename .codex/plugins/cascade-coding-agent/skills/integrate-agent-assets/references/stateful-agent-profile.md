# Stateful-agent integration profile

Load only when the accepted packet adopts Analyzer–Policy Engine–Composer or
`schema-values-text@1`. Do not infer adoption from generic context or tool work.
