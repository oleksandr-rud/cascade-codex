---
name: derive-persona-requirements
description: Translate an existing frozen Cascade Persona agent-architecture projection into evidence-bound user-model requirements for an AI-system blueprint. Use only when architecture needs supported capabilities, contexts, constraints, failure modes, or interaction requirements; do not create or evaluate personas or compile simulation actors.
---

# Derive Persona Requirements
