...
| Authority | Analyzer proposes; runtime admits/commits/dispatches and sets hard limits; Composer owns novel answer meaning and ordinary response strategy; Voice presents; adapters report effects/delivery. A fixed approved status phrase is a narrow runtime exception, not a second semantic author. | [Role boundaries](analyzer-policy-composer.md) |
