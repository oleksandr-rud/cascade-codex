...
def validate_profiles(profiles: Any, errors: list[str]) -> None:
    ...
    if acceptance.get("minimum_normalized_score") != 0.95:
        errors.append("minimum normalized score must be 0.95")
    if acceptance.get("minimum_dimension_rating") != 3:
        errors.append("minimum dimension rating must be 3")
