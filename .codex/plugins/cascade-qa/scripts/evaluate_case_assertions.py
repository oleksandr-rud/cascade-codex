#!/usr/bin/env python3
"""Mechanical eligibility adapter for Cascade QA evaluations."""
...
if SPEC is None or SPEC.loader is None:
    raise RuntimeError("unable to load QA artifact validator")
VALIDATOR = importlib.util.module_from_spec(SPEC)
SPEC.loader.exec_module(VALIDATOR)
SCHEMA = VALIDATOR.read_json(ROOT / "schemas" / "qa-artifact.schema.json")
SUPPORTED = {"status_matches_expected", "selected_skill_matches_expected", "qa_artifact_validates"}
...
def evaluate(suite: dict[str, Any], target: dict[str, Any]) -> dict[str, Any]:
    ...
    for case in expected:
        ...
        for assertion_id in case["mechanical_assertions"]:
            ...
            elif assertion_id == "qa_artifact_validates":
