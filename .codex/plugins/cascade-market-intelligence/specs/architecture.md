...
eligibility checks status, typed `selected_skill`, ledger, opportunity, and
experiment artifact/schema/cross-field/digest validity for every case, and required handoffs. A manifest-bound
