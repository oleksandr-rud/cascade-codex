...
Version: 0.1.20+codex.20260826233510

This package consolidates human-model capabilities that were previously split across repository product documentation, Cascade Simulations, and Cascade Architect. The paths below are development provenance, not runtime dependencies.
...
| Architecture-facing persona design | cascade-ai-architect:derive-persona-requirements | compile-persona architecture view | Cascade Architect consumes the view; it no longer needs to own a second canonical schema |
