...
const model=value("judge-model")??"gpt-5.6-sol";
const reasoningEffort=value("judge-reasoning-effort")??"max";
...
const contract={run_id:runId,model,reasoning_effort:reasoningEffort,explicit_comparison:model!=="gpt-5.6-sol"||reasoningEffort!=="max",profile_sha256:digest(JSON.stringify(profile)),catalog_sha256:digest(JSON.stringify(catalog)),runner_bundle_sha256:await runnerDigest(scripts),human_calibration:"NOT_RUN"};
