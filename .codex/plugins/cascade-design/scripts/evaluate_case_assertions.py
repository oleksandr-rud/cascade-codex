#!/usr/bin/env python3
"""Mechanical eligibility adapter for Cascade Design agent evaluations."""
...
if VALIDATOR_SPEC is None or VALIDATOR_SPEC.loader is None:
    raise RuntimeError("unable to load design artifact validator")
VALIDATOR = importlib.util.module_from_spec(VALIDATOR_SPEC)
VALIDATOR_SPEC.loader.exec_module(VALIDATOR)
SCHEMA = VALIDATOR.read_json(ROOT / "schemas" / "design-review.schema.json")

SUPPORTED_ASSERTIONS = {
    "status_matches_expected",
    "selected_skill_matches_expected",
    "design_artifact_validates",
}
...
def evaluate(suite: dict[str, Any], target_output: dict[str, Any]) -> dict[str, Any]:
    ...
    for case in expected_cases:
        ...
        for assertion_id in case["mechanical_assertions"]:
            ...
            elif assertion_id == "design_artifact_validates":
