...
Ported from Cascade Simulations `simulation-persona` version `0.2.0`. Compiled
and audited with Cascade Prompt `0.6.0`; Advanced mode with grounded synthesis,
extraction, sensitive-data, balanced-production, and evaluation controls.
