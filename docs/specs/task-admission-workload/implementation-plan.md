...
|---|---|---|---|---|---|---|
| `SL-01` | WL-01 | envelope, claims, axes, routes, policies, control packs | `.codex/task-admission/task-envelope.schema.json`; `policy.schema.json`; `control-catalog.yaml`; `policies/core.yaml`; `scripts/cascade/validate.ts` | validated contract bundle | positive/negative schemas; ambiguity/conflict failures | schema or authority ambiguity returns to WL-01 |
